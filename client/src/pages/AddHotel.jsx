...
const AddHotelForm = () => {
  ...
  useEffect(() => {
    const fetchRegionsWithSubregions = async () => {
      try {
        const response = await axios.get("https://hotel-theta-three.vercel.app/api/region"); // Adjust the endpoint as per your API
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("https://hotel-theta-three.vercel.app/api/new/hotel", hotelData, {
        headers: {
